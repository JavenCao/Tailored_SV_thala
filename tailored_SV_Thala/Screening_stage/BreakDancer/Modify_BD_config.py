...
def Remove_outliers_BD_config(path2hist):
    """
Description: exclude insert size larger than 4k, and then re-calculate statistics
...
input: path2hist: the histogram file generated by breakdancer
       path2cfg: raw config files
       path2newcfg: newly created breakdancer config files
return: path2newcfg
    """
    mean_val, std_val, lower_val, upper_val = Remove_outliers_BD_config(path2hist)
